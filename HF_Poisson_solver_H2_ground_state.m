function [] = HF_Poisson_solver_H2_ground_state
%-----------------------------------------------------------------
% Solves the Hartree-Fock equation for ground state of molecular
...
clc;
format long
N = 32.; M = 12; a = 1.; b = 40.;  % Initial computaional parameters; you may change them
